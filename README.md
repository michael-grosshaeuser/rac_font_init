...
[Nerd Fonts](https://github.com/ryanoasis/nerd-fonts) (e.g., Hack) into a Docker
volume.  
The container verifies the signature of the used base image with
[cosign](https://github.com/sigstore/cosign)
before starting, compiles a small C++ application for copying the fonts, and
uses a minimal, secure runtime image.
